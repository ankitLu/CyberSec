...
public class Worker
{
  ...
  public void crawlMainPage(String url, String id){
	  try
      {
         ...
         for (String newsPart : news) {
        	 ++i;
        	 writeToFile(newsPart,"Issue_xix_"+id+"#"+i+".txt");
         }
  ...
  public void writeToFile(String text, String filename){
  	    ...
  	    try {
  	    	...
  	    	File directory = new File("C:\\Season\\Spring18\\RA\\Sans\\"+Start.folder);
  	    	if(!directory.exists()) {
  	    		directory.mkdir();
  	    	}
  	    	
  	    	BufferedWriter writer = new BufferedWriter(new FileWriter("C:\\Season\\Spring18\\RA\\Sans\\"+Start.folder+"\\"+filename));
				writer.write(text);
				writer.close();
			} catch (IOException e) {
