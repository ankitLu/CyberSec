...
def setup_module(module):
    word2vec2.word2phrase(input_, output_phrases, verbose=False)
    word2vec2.word2vec(input_, output_bin, size=10, binary=1, verbose=False)
    word2vec2.word2vec(input_, output_txt, size=10, binary=0, verbose=False)
    word2vec2.word2clusters(input_, output_clusters, 10, verbose=True)
